...
import { DEFAULT_INPUT, type PensionInput, type PensionOutput } from '../types/pension';
...
<template>
  <main class="page">
    ...
    <el-row :gutter="16">
      ...
      <el-col :xs="24" :md="12">
        <ResultPanel :output="output" :errors="validation.errors" :warnings="validation.warnings" />
      </el-col>
    </el-row>
